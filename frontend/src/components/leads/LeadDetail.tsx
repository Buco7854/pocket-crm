...
export default function LeadDetail({ lead, onStatusChange, canEdit }: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-8 text-sm border-t border-surface-200 pt-4">
        ...
        <div><span className="text-surface-500">{t('fields.closedAt')}:</span> <span className="text-surface-900 ml-1">{fmt(lead.closed_at)}</span></div>
