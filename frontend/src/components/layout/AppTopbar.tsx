  ...
  return (
    <>
      ...
      >
        ...
        {/* Search trigger */}
        <button
          className="relative hidden md:flex items-center gap-2 h-9 w-64 rounded-lg border border-surface-200 bg-surface-50 pl-3 pr-3 text-sm text-surface-400 hover:border-surface-300 hover:bg-surface-100 transition-all cursor-pointer"
          onClick={openSearch}
        >
          <Search className="h-4 w-4 shrink-0" strokeWidth={2} />
          <span className="flex-1 text-left text-sm text-surface-400">{t('common.search')}</span>
          <kbd className="hidden lg:inline-flex items-center gap-0.5 rounded border border-surface-200 bg-surface-100 px-1.5 py-0.5 text-[10px] font-medium text-surface-400">
            ⌘K
          </kbd>
        </button>
        ...
        {/* Mobile search icon */}
        <button
          className="md:hidden flex items-center justify-center h-9 w-9 rounded-lg text-surface-500 hover:bg-surface-100 transition-colors"
          onClick={openSearch}
        >
